...
function Environment.Blacklist(self, Username)
	assert(self and Username, "Missing parameters.")
	Username = FixUsername(Username)
	assert(self, "User "..Username.." couldn't be found.")
...
function Environment.Whitelist(self, Username)
	assert(self and Username, "Missing parameters.")
	Username = FixUsername(Username)
	assert(Username, "User "..Username.." couldn't be found.")
	local Index = tablefind(self.Blacklisted, Username)
	assert(Index, "User "..Username.." is not blacklisted.")
